...
class ImportIdentityProvidersIT extends AbstractImportTest {
  ...
  void shouldUpdateOidcIdentityProviderWithMapper() {
    doImport("4_update_identity-provider_for_keycloak-oidc_with_mapper.json");
  ...
  void shouldUpdateOidcIdentityProviderWithUpdatedMapper() {
    doImport("5_update_identity-provider_for_keycloak-oidc_with_updated_mapper.json");
    ...
    IdentityProviderMapperRepresentation myUsernameMapper = createdRealm.getIdentityProviderMappers().stream().filter(m -> m.getName().equals("my-updated-username-mapper")).findFirst().get();
  ...
  void shouldUpdateOidcIdentityProviderWithDeleteAllMappers() {
    doImport("6_update_identity-provider_for_keycloak-oidc_with_deleted_mapper.json");
  ...
  void shouldDeleteOidcIdentityProvider() {
    doImport("7_delete_identity-provider_for_keycloak-oidc.json");
